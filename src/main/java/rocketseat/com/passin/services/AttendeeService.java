...
public class AttendeeService {
    ...
    public AttendeeBadgeResponseDTO getAttendeeBadge(String attendeeId, UriComponentsBuilder uriComponents){
        Attendee attendee = this.getAttendee(attendeeId);

        var uri = uriComponents.path("/attendees/{attendeeId}/check-in").buildAndExpand(attendeeId).toUri().toString();
